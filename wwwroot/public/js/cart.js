        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $.each(res, function (i, item) {
                    ...
                    html+= "<tr>"
                        + "<td style=\"width: 50px;\" class=\"cart_product\">"
                        + "<img style=\"width: 100%;\" src=\"/product-image/" + item.image + "\" />"
                        +"</td>"
                        + "<td class=\"cart_description\" style=\"width: 270px;\">"
                        + "<h4 class=\"shortName\"><a href=\"/Product/Detail?id=" + item.productId + "&colorId=" + item.colorId + "\" style=\"font-size: 12px;\">" + item.name + "</a></h4>"
